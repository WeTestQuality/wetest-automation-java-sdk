...
public class SlotSwitchCancelRequest extends AbstractRequestWithoutSpecificBodyGenerator {
    @SerializedName("slot_out_addr")
    @Expose
    private String slotOutAddr;

    public SlotSwitchCancelRequest(){
        this.setHttpMethod(HttpProfile.REQ_POST);
        this.withApiInfo("v1", "/slot/switch/cancel");
    }
    @Override
